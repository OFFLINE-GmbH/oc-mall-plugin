...
class Discount extends Model
{
    ...
    public $belongsToMany = [
        ...
        'products' => [Product::class, 'table' => 'offline_mall_cart_discount_products'],
        'variants' => [Variant::class, 'table' => 'offline_mall_cart_discount_variants'],
        'categories' => [Category::class, 'table' => 'offline_mall_cart_discount_categories'],
    ];
