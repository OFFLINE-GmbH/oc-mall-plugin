...
// Handles Responses generated by a PaymentProvider. It just renders
// the contents of the mall.checkout.response session key. This way a
// PaymentProvider may render a HTML form to execute custom POST
// requests to a PaymentGateway.
