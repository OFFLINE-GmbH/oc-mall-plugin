<?php return [
    ...
    'discounts'                => [
        ...
        'alternate_price'                      => 'Альтернативная цена',
    ...
    'permissions'              => [
        ...
        'settings'                => [
            ...
            'manage_api'             => 'Может управлять API настройками магазина',
    ...
    'components'               => [
        ...
        'product'                => [
            ...
            'properties'    => [
                'productSlug' => [
                    'title'       => 'Параметр URL товара',
                    'description' => 'Этот параметр используется для загрузки slug из URL-адреса',
                ],
            ],
