...
return [
    "category" => [
        ...
        "inherit_review_categories" => "Наследовать просмотр категорий родительской категории",
        "inherit_review_categories_comment" => "Используйте категории обзора родительской категории этой категории",
        "name" => "Имя",
    ...
    "common" => [
        ...
        "invalid_quantity" => "Указанное количество недействительно",
        ...
        "review" => "Отзыв",
        "review_categories" => "Обзор категорий",
        "review_category" => "Обзор категории",
        "reviews" => "Отзывы",
    ...
    "components" => [
        ...
        "cart" => [
            ...
            "properties" => [
                ...
                "showProceedToCheckoutButton" => ["title" => "Показать кнопку «Перейти к оформлению заказа»"],
                "showShipping" => ["title" => "Показать стоимость доставки"],
        ...
        "category" => [
            "by_slug" => "Используйте категорию в URL как родительский",
            "no_parent" => "Показать все категории",
            "properties" => [
                "categoryPage" => [
                    "description" => "Ссылки будут указывать на эту страницу. Если ничего не указано, будут использованы настройки бэкенда по умолчанию.",
                    "title" => "Страница категории"
                ],
                "categorySlug" => [
                    "description" => "Используйте этот параметр для загрузки родительской категории из URL.",
                    "title" => "Параметр категории слаг"
                ],
                "parent" => [
                    "description" => "Показывать только детей в этой категории",
                    "title" => "Начальная категория"
                ]
            ]
        ],
        "checkout" => [
        ...
        "discountApplier" => [
            ...
            "discount_applied" => "Скидка применена успешно!"
        ],
        "enhancedEcommerceAnalytics" => [
            "details" => [
                "description" => "Реализует слой данных менеджера тегов Google",
                "name" => "Компонент расширенной электронной коммерции (UA)"
            ]
        ],
        "myAccount" => [
            "details" => [
        ...
        "product" => [
            ...
            "properties" => [
                "redirectOnPropertyChange" => [
                    "description" => "Перенаправить пользователя на новую страницу сведений, если свойство было изменено",
                    "title" => "Перенаправление при изменении свойства"
                ]
            ]
        ],
        "productReviews" => [
            "details" => ["description" => "Отображает все отзывы о продукте", "name" => "Отзывы о товаре"],
            "properties" => [
                "currentVariantReviewsOnly" => [
                    "description" => "Не показывать обзоры других вариантов этого продукта",
                    "title" => "Показать только оценки этого варианта"
                ],
                "perPage" => ["title" => "Количество отзывов на странице"]
            ]
        ],
        "products" => [
        ...
        "productsFilter" => [
            ...
            "properties" => [
                ...
                "showOnSaleFilter" => ["title" => "Показать в продаже фильтр"],
        ...
        "signup" => [
            ...
            "errors" => [
                ...
                "not_activated" => "Ваша учетная запись должна быть активирована, прежде чем вы сможете войти.",
                "password" => [
                ...
                "terms_accepted" => ["required" => "Пожалуйста, примите наши условия."],
        ...
        "wishlistButton" => [
            "details" => [
                "description" => "Отображает кнопку списка желаний",
                "name" => "Кнопка списка желаний"
            ],
            "properties" => [
                "product" => ["description" => "Идентификатор продукта", "name" => "Товар"],
                "variant" => ["description" => "Идентификатор варианта", "name" => "вариант"]
            ]
        ],
        "wishlists" => [
            "details" => [
                "description" => "Отображение менеджера списков желаний",
                "name" => "Списки желаний"
            ],
            "properties" => [
                "showShipping" => [
                    "description" => "Показать стоимость доставки и селектор",
    ...
    "customer_group" => [
        ...
        "discount_comment" => "Дайте этой группе клиентов особую скидку в% на весь каталог"
    ],
    "discounts" => [
    ...
    "feed_settings" => [
        "description" => "Настройка каналов торгового центра",
        "google_merchant_enabled" => "Включить канал Google Merchant Center",
        "google_merchant_enabled_comment" => "Будет создан канал продукта",
        "google_merchant_url" => "URL вашего Google Merchant Feed",
        "google_merchant_url_locale" => "Добавьте? Locale = xy, чтобы получить локализованный канал."
    ],
    "general_settings" => [
        ...
        "click_and_collect" => [
            "percent" => "Нажмите и соберите рейтинг",
            "percent_comment" => "Процент, который должен быть заплачен, чтобы заказать продукты",
            "use_state" => "Включить Click and Collect",
            "use_state_comment" => "Включить или отключить клик и собирать"
        ],
        "customizations" => "Настройки",
        "customizations_comment" => "Настройте функции вашего магазина",
        "description" => "Общие параметры",
        "group_search_results_by_product" => "Группировать результаты поиска по продукту",
        "group_search_results_by_product_comment" => "Включить продукт только один раз в результаты поиска, не отображать все соответствующие варианты",
        "index_driver" => "Индексный драйвер",
        ...
        "index_driver_hint" => "Если вы измените эту опцию, обязательно запустите «php artisan mall: reindex» в командной строке, чтобы переиндексировать ваши продукты!",
        "label" => "Конфигурация",
        "links" => "CMS страницы",
        ...
        "use_state" => "Используйте поле State / County / Province",
        "use_state_comment" => "Клиенты должны выбрать штат / округ / провинцию во время регистрации"
    ],
    "image_sets" => [
    ...
    "order" => [
        ...
        "tracking_completed_comment" => "Заказ будет помечен как завершенный",
    ...
    "payment_gateway_settings" => [
        ...
        "postfinance" => [
            "hashing_method" => "Алгоритм хеширования",
            "hashing_method_comment" => "Конфигурация -> Техническая информация -> Глобальные параметры безопасности",
            "pspid" => "PSPID (имя пользователя)",
            "sha_in" => "Подпись SHA-IN",
            "sha_in_comment" => "Конфигурация -> Техническая информация -> Проверка данных и происхождения",
            "sha_out" => "Подпись SHA-OUT",
            "sha_out_comment" => "Конфигурация -> Техническая информация -> Отзыв о транзакции",
    ...
    "payment_log" => [
        "code_comment" => "Этот код был возвращен поставщиком платежа",
        "data_comment" => "Эти данные были возвращены поставщиком платежа",
        "failed_only" => "Не удалось только",
        "message_comment" => "Это сообщение было возвращено поставщиком платежа",
        "order_data_comment" => "Это все данные заказа для этого платежа",
    ...
    "payment_method" => [
        ...
        "instructions_comment" => "Синтаксис Twig поддерживается. Используйте {{ order }} или {{ cart }} для доступа к соответствующей информации, если она доступна",
        "pdf_partial" => "Частичное вложение в PDF",
        "pdf_partial_comment" => "Для всех заказов с этим методом оплаты к письму с уведомлением будет приложен отрендеренный PDF выбранного фрагмента.",
        "pdf_partial_none" => "Нет PDF-вложения",
    ...
    "permissions" => [
        ...
        "manage_payment_log" => "Может управлять журналом платежей",
    ...
    "product" => [
        ...
        "embeds" => "Встраивание",
        "filter_virtual" => "Показывать только виртуальные продукты",
        "general" => "Общие",
        "group_by_property" => "Атрибут для варианта группировки",
        "gtin" => "Глобальный товарный номер (GTIN)",
        "height" => "Высота (мм)",
        ...
        "is_virtual_comment" => "Этот продукт является виртуальным (файл, без доставки)",
        "length" => "Длина (мм)",
        "link_target" => "Целевой URL-адрес",
        "link_title" => "Название",
        "links" => "Ссылки",
        "missing_category" => "Продукт не имеет категории, связанной с ним. Пожалуйста, выберите категорию ниже, чтобы редактировать этот продукт.",
        ...
        "product_file" => "Файл продукта",
        "product_file_version" => "версия файла",
        "product_files" => "Файлы продукта",
        "product_files_section_comment" => "Это виртуальный продукт. Вы можете загрузить новые версии файлов ниже. Последняя версия будет доступна для скачивания клиентами.",
        "properties" => "Свойства",
        ...
        "variant_support_text" => "Выбранная категория не имеет определенных свойств Variant. Пожалуйста, переключите метод управления запасами на «Товар» или выберите другую категорию.",
        "weight" => "Вес (г)",
        "width" => "Ширина (мм)"
    ],
    "product_file" => [
        "display_name_comment" => "Это имя будет видно клиенту.",
        "download_count" => "Количество загрузок",
        "errors" => [
            "expired" => "Ссылка для скачивания истекла",
            "invalid" => "Неверная ссылка для скачивания",
            "not_found" => "Не удается найти запрошенный файл, пожалуйста, свяжитесь с нами для поддержки.",
            "too_many_attempts" => "Слишком много попыток загрузки"
        ],
        "expires_after_days" => "Загрузка действительна в течение нескольких дней",
        "expires_after_days_comment" => "Файл можно скачать только через много дней после покупки. Оставьте пустым без ограничений.",
        "file" => "файл",
        "hint" => [
            "info_link" => "в документации",
            "info_text" => "Вы можете найти информацию о том, как это сделать",
            "intro" => "К этому продукту не прикреплен файл. Пожалуйста, не забудьте добавить один или программно гееренировать его во время оформления заказа."
        ],
        "max_download_count" => "Максимальное количество скачиваний",
        "max_download_count_comment" => "Файл может быть загружен только много раз. Оставьте пустым без ограничений.",
        "session_required" => "Требуется логин",
    ...
    "review_settings" => [
        ...
        "allow_anonymous_comment" => "Незарегистрированные пользователи могут создавать отзывы",
        "description" => "Настроить отзывы",
        "enabled" => "Отзывы включены",
        "enabled_comment" => "Клиенты могут создавать отзывы",
        "moderated" => "Умеренные отзывы",
        "moderated_comment" => "Новые отзывы должны публиковаться вручную администратором сайта."
    ],
    "reviews" => [
        "anonymous" => "анонимное",
        "approve_next" => "Одобрить и перейти к следующему",
        "cons" => "Негативные аспекты",
        "no_more" => "Нет больше неутвержденных отзывов",
        "only_unapproved" => "Показывать только неподтвержденные",
        "pros" => "Положительные аспекты",
        "rating" => "рейтинг",
        "review" => "Подробности обзора",
        "title" => "Название вашего обзора"
    ],
    "services" => [
        "option" => "вариант",
        "options" => "опции",
        "required" => "Требуется обслуживание",
        "required_comment" => "Одна опция этой услуги должна быть выбрана, когда товар добавлен в корзину."
    ],
    "shipping_method" => [
        ...
        "not_required_description" => "Текущая корзина не требует доставки.",
    ...
    "titles" => [
        ...
        "reviews" => ["create" => "Создать обзор", "update" => "Редактировать отзыв"],
        "services" => ["create" => "Создать сервис", "update" => "Редактировать Сервис"],
        "shipping_methods" => [
