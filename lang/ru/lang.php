...
return [
    ...
    "components" => [
        ...
        "productReviews" => [
            "details" => ["description" => "Показать все отзывы о товаре", "name" => "Отзывы о товаре"],
            "properties" => [
        ...
        "productsFilter" => [
            ...
            "properties" => [
                ...
                "showOnSaleFilter" => ["title" => "Показать фильтр распродажи"],
        ...
        "quickCheckout" => [
            ...
            "errors" => ["signup_failed" => "Не удалось создать учетную запись пользователя."]
        ],
        ...
        "signup" => [
            ...
            "errors" => [
                ...
                "terms_accepted" => ["required" => "Пожалуйста, примите наши условия и положения."],
        ...
        "wishlistButton" => [
            ...
            "properties" => [
                "product" => ["description" => "ID товара", "name" => "Товар"],
                "variant" => ["description" => "ID варианта", "name" => "Variant"]
            ]
        ],
        "wishlists" => [
            "details" => [
    ...
    "discounts" => [
        ...
        "triggers" => [
            ...
            "shipping_method" => "Способ доставки является одним из следующих",
    ...
    "titles" => [
        ...
        "reviews" => ["create" => "Создать отзыв", "update" => "Редактировать отзыв"],
        "services" => ["create" => "Создать услугу", "update" => "Редактировать услугу"],
        "shipping_methods" => [
