<?php return [
    ...
    'titles'                   => [
        ...
        'order_states'         => [
            'create'  => 'Crea status',
            'edit'    => 'Modifica status',
            'reorder' => 'Riordina status',
        ],
        'brands'               => [
            'create' => 'Crea brand',
            'edit'   => 'Modifica brand',
    ...
    'menu_items'               => [
        ...
        'all_variants'    => 'Tutte le variazioni',
    ],
    'currency_settings'        => [
        'label'             => 'Valute',
    ...
    'general_settings'         => [
        ...
        'admin_email_comment'        => 'Le notifiche admin verranno spedite a questo indirizzo',
        'base'                       => 'Impostazioni base',
        'links'                      => 'Pagine CMS',
        'links_comment'              => 'Scegli quali pagine verranno usate per visualizzare i tuoi prodotti',
        ...
        'index_driver'               => 'Driver per l\'indice',
        ...
        'index_driver_hint'          => 'Se cambi questa opzione assicurati di eseguire "php artisan mall:reindex" nella riga di comando per ri-indicizzare i tuoi prodotti!',
    ],
    'common'                   => [
        'shop'                 => 'Negozio',
        'products'             => 'Prodotti',
        ...
        'use_backend_defaults' => 'Usa le impostazioni configurate nel pannello impostazioni del backend',
        ...
        'product_or_variant'   => 'Prodotto/Variazione',
        'code'                 => 'Codice',
        'code_comment'         => 'Questo codice può essere usato per identificare questo record programmaticamente',
        // TODO controllare
        'checked'              => 'Verificato',
        // TODO controllare
    ...
    'variant'                  => [
        'method' => [
            'single'  => 'Articolo',
            'variant' => 'Variazioni articolo',
        ],
    ],
    'properties'               => [
        'use_for_variants'         => 'Usa per le variazioni',
        'use_for_variants_comment' => 'Questa proprietà é differente per ogni variazione di questo prodotto',
        'filter_type'              => 'Filtra tipi',
        'filter_types'             => [
            'none'  => 'Senza filtro',
            'set'   => 'Imposta',
            'range' => 'Intervallo',
    ...
    'product'                  => [
        ...
        'link_title'                           => 'Titolo',
        'link_target'                          => 'URL bersaglio',
        'properties'                           => 'Proprietà',
        'links'                                => 'Link',
        'details'                              => 'Dettagli',
        'price_includes_tax'                   => 'Prezzo tasse incluse',
        'price_includes_tax_comment'           => 'Il prezzo definito include tutte le tasse',
        'group_by_property'                    => 'Attributo per il raggruppamento per variazioni',
        'additional_descriptions'              => 'Descrizioni addizionali Additional descriptions',
        'additional_properties'                => 'Proprietà addizionali',
        'price_table_modal'                    => [
            'trigger'           => 'Modifica quantità e valori di prezzo',
            'label'             => 'Prezzo e quantità',
            'title'             => 'Panoramica prezzi e quantità',
            'currency_dropdown' => 'Valuta: ',
        ],
        'missing_category'                     => 'Il prodotto non ha associata una categoria. Per favore scegli una categoria sotto per modificare questo prodotto.',
        'variant_support_header'               => 'Variazioni non supportate',
        'variant_support_text'                 => 'La categoria selezionata non ha Variazioni definite. Per favore cambia il metodo di gestione inventario in "Articolo" o seleziona un\'altra categoria.',
    ],
    'image_sets'               => [
    ...
    'category'                 => [
        ...
        'parent'                          => 'Genotire',
        'no_parent'                       => 'Nessun genotire',
        'inherit_property_groups'         => 'Eredita le proprietà dalla categoria genitore',
        'inherit_property_groups_comment' => 'Usa i gruppi di proprietà del genitore di questa categoria',
    ],
    'custom_fields'            => [
        'name'             => 'Nome campo',
        'type'             => 'Tipo campo',
    ...
    'discounts'                => [
        ...
        'shipping_description'                 => 'Nome di un metodo di spedizione alternativo',
        ...
        'validation'                           => [
            ...
            'shipping'            => 'Puoi applicare solo un codice promozionale che abbassa le spese di spedizione.',
    ...
    'payment_method'           => [
        ...
        'fee_percentage'         => 'Tariffa a percentuale',
        'fee_percentage_comment' => 'La percentuale del totale da aggiungere al totale dell\'ordine',
        'fee_label'              => 'Etichetta della tariffa',
        'fee_label_comment'      => 'Questo testo sarà mostrato ai clienti durante il check out.',
        'instructions'           => 'Istruzioni di pagamento',
        'instructions_comment'   => 'Sintassi Twig supportata. Usa {{ order }} per accedere all\e informazioni dell\'ordine, se disponibili',
    ],
    'order'                    => [
        'order_number'                        => '# Ordine',
        ...
        'shipping_provider'                   => 'Fornitore di spedizione',
        ...
        'items_total'                         => 'Totale oggetti',
        'subtotal'                            => 'Subtotale',
        'taxable_total'                       => 'Totale imponibile',
        'total_weight'                        => 'Totale peso',
        ...
        'deleting'                            => 'Eliminandfo l\'ordine...',
        'delete_confirm'                      => 'Sei sicuro di vole eliminare questo ordine?',
    ...
    'permissions'              => [
        ...
        'manage_properties'         => 'Può modificare le proprietà dei prodotti Can edit product properites',
    ...
    'components'               => [
        'products'               => [
            ...
            'properties' => [
                ...
                'filter_component'   => [
                    'title'       => 'Alias del component Filter',
                    'description' => 'Alias del component "ProductsFilter" che filtra questo component "Products"',
                ],
                'filter'             => [
                    'title'       => 'Filter string',
                    'description' => 'Forza il filtro per questo component',
                ],
                'include_variants'   => [
                    'title'       => 'Mostra le variazioni dell\'articolo',
                    'description' => 'Non mostrare il singolo prodotto, ma tutte le variazioni disponibili',
                ],
                'include_children'   => [
                    'title'       => 'Includi i figli',
                    'description' => 'Mostra anche tutti i prodotti delle categorie figlio',
                ],
                'per_page'           => [
                    'title'       => 'Per pagina',
                    'description' => 'Quanti prodotti vengono visualizzati per pagina',
                ],
                'paginate'           => [
                    'title'       => 'Paginazione',
                ...
                'sort'               => [
                    'title'       => 'Ordina',
                    'description' => 'Questo sovrascrive le impostazioni delle preferenze dell\'utente',
                ],
                'set_page_title'     => [
                    'title'       => 'Imposta il titolo di pagina',
        ...
        'productsFilter'         => [
            'details'    => [
                ...
                'description' => 'Filtra i prodotti da una categoria',
            ],
            'properties' => [
                'showPriceFilter'     => [
                ...
                'includeChildren'     => [
                    'title'       => 'Includi figli',
                    'description' => 'Include le proprietà e i filtri anche dai prodotti nelle categorie figlio',
                ],
                'includeVariants'     => [
                    'title'       => 'Includi variazioni',
                    'description' => 'Mostra i filtri per le proprietà delle variazioni',
                ],
                'includeSliderAssets' => [
        ...
        'shippingMethodSelector' => [
            ...
            'errors'  => [
                'unavailable' => 'Il metodo di spedizione selezionate non é disponibile per il tuo ordine.',
            ],
        ],
        'paymentMethodSelector'  => [
            'details' => [
                'name'        => 'Selettore metodo di pagamento',
                'description' => 'Mostra una lista di tutti i metodi di pagamento dispionibili',
            ],
            'errors'  => [
        ...
        'signup'                 => [
            ...
            'errors'     => [
                'user_is_guest'   => 'Stai provando ad accedere con un account guest.',
                'unknown_user'    => 'Le credenziali che hai inserito non sono valide.',
                'login'           => [
                    'required' => 'Per favore, inserisci un indirizzo email.',
                    'email'    => 'Per favore, indirizzi un indirizzo email valido.',
                    'between'  => 'Per favore, indirizzi un indirizzo email valido.',
                ],
                'password'        => [
                ...
                'password_repeat' => [
                    ...
                    'same'     => 'La conferma password non coincide la password scelta.',
                ],
                'email'           => [
                    'required'          => 'Per favore, inserisci un indirizzo email.',
        ...
        'categories'             => [
            ...
            'properties' => [
                'parent'       => [
                    ...
                    'description' => 'Mostra solo le categorie figlio di questa categoria',
                ],
                'categorySlug' => [
                    'title'       => 'Parametro slug di categoria',
                    'description' => 'Usa questo parametro per caricare la categoria figlio dall\'url',
                ],
                'categoryPage' => [
                    'title'       => 'Pagina categoria',
                    'description' => 'I link punteranno a questa paginal. Se lasciato vuoto, verranno usate le impostazioni di default del backend.',
                ],
            ],
            'no_parent'  => 'Mostra tutte le categorie',
            'by_slug'    => 'Usa la categoria nell\'url come parente',
        ],
        'cartSummary'            => [
            'details'    => [
                'name'        => 'Riepilogo carrello',
                'description' => 'Mostra il numero di prodotto e il valore complessivo del carrello',
            ],
            'properties' => [
                'showItemCount'  => [
                    'title'       => 'Mostra conteggio prodotti',
                    'description' => 'Mostra il conteggio degli oggetti nel carrello',
                ],
                'showTotalPrice' => [
                    'title'       => 'Mostra il valore totale',
                    'description' => 'Mostra il valore totale di tutti gli oggetti nel carrello',
                ],
            ],
        ],
        'customerDashboard'      => [
            'details'    => [
                ...
                'description' => 'Mopstra un link alla pagina del cliente o a quella di login e cambia le loro impostazioni',
            ],
            'properties' => [
                'customerDashboardLabel' => [
                    'title'       => 'Label per la dashboard cliente',
    ...
    'products'                 => [
        'variants_comment' => 'Crea più variazioni dello stesso prodotto',
    ],
    'order_states'             => [
        'name'        => 'Nome',
        'description' => 'Descrizione',
        ...
        'flags'       => [
            ...
            'cancelled' => 'Imposta lo stato di quest\'ordine come "cancellato"',
        ],
    ],
    'customer_group'           => [
        'code_comment'     => 'Questo codice può essere usato per identificare questo groppo programmaticamente',
