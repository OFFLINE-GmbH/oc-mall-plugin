...
return [
    ...
    "components" => [
        ...
        "addressList" => [
            ...
            "messages" => ["address_deleted" => "Indirizzo eliminato"]
        ],
        "addressSelector" => [
            "details" => [
    ...
    "general_settings" => [
        ...
        "click_and_collect" => [
            "percent" => "Percentuale Click and Collect",
            "percent_comment" => "Percentuale da corrispondere per prenotare i prodotti",
            "use_state" => "Abilita Click and Collect",
            "use_state_comment" => "Abilia o disabilita il click and collect"
        ],
