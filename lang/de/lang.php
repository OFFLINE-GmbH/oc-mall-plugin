...
return [
    ...
    "components" => [
        "addressForm" => [
            ...
            "properties" => [
                ...
                "redirect" => ["title" => "Weiterleitung (nach Speichern)"],
                "set" => ["title" => "Übernehme die Adresse für die Bestellung als..."]
            ],
            "redirects" => ["checkout" => "Checkout-Seite"],
            "set" => ["billing" => "Rechnungsadresse", "shipping" => "Versandadresse"]
        ],
        "addressList" => [
            "details" => [
        ...
        "cart" => [
            "details" => ["description" => "Zeigt den Warenkorb an", "name" => "Warenkorb"],
            "properties" => [
                "discountCodeLimit" => ["description" => "", "title" => ""],
                "showDiscountApplier" => ["title" => "Rabatt-Code-Feld anzeigen"],
                "showProceedToCheckoutButton" => ["title" => "Zur Kasse-Button anzeigen"],
                "showShipping" => ["title" => "Versandkosten anzeigen"],
                "showTaxes" => ["title" => "Steuern ausweisen"]
            ]
        ],
        "cartSummary" => [
            "details" => [
        ...
        "categories" => [
            ...
            "details" => ["description" => "Listet vorhandene Kategorien auf", "name" => "Kategorien"],
        ...
        "checkout" => [
            "details" => ["description" => "Komponente für den Bestellvorgang", "name" => "Checkout"],
            "errors" => ["missing_settings" => "Bitte wählen Sie eine Zahlungs- und Versandmethode aus."],
            "properties" => ["step" => ["name" => "Aktiver Schritt des Checkouts (wird automatisch gesetzt)"]]
        ],
        "currencyPicker" => [
            "details" => [
        ...
        "customerDashboard" => [
            ...
            "properties" => [
                ...
                "logoutLabel" => ["description" => "Link-Text für den Logout-Link", "title" => "Logout-Text"]
            ]
        ],
        "customerProfile" => [
            "details" => [
        ...
        "myAccount" => [
            ...
            "properties" => ["page" => ["title" => "Aktive Unterseite"]]
        ],
        "ordersList" => [
            "details" => [
        ...
        "productReviews" => [
            ...
            "properties" => [
                ...
                "perPage" => ["title" => "Anzahl Reviews pro Seite"]
            ]
        ],
        "products" => [
            "details" => ["description" => "Zeigt eine Liste von Produkten an", "name" => "Produkte"],
            "properties" => [
                "filter" => [
        ...
        "productsFilter" => [
            ...
            "properties" => [
                ...
                "showBrandFilter" => ["title" => "Zeige Marken-Filter an"],
                "showOnSaleFilter" => ["title" => "Zeige «Reduziert» Filter an"],
                "showPriceFilter" => ["title" => "Zeige Preis-Filter an"],
                "sortOrder" => ["description" => "Standard Sortierung", "title" => "Sortierung"]
            ],
            "sortOrder" => [
        ...
        "quickCheckout" => [
            "details" => ["description" => "Checkout auf einer Seite", "name" => "Schneller Checkout"],
            "errors" => ["signup_failed" => "Fehler beim Erstellen Ihres Benutzerkontos."]
        ],
        ...
        "signup" => [
            ...
            "errors" => [
                "city" => ["required" => "Geben Sie eine Stadt ein."],
                "country_id" => [
                ...
                "firstname" => ["required" => "Geben Sie Ihren Vornamen ein."],
                "lastname" => ["required" => "Geben Sie Ihren Nachnamen ein."],
                "lines" => ["required" => "Geben Sie Ihre Adresse ein."],
                "login" => [
                ...
                "terms_accepted" => ["required" => "Bitte bestätigen Sie unsere AGBs."],
                "unknown_user" => "Die eingegebenen Login-Daten sind ungültig.",
                "user_is_guest" => "Sie versuchen sich mit einem Gast-Konto einzuloggen.",
                "zip" => ["required" => "Geben Sie Ihre PLZ ein."]
            ],
            "properties" => ["redirect" => ["name" => "Weiterleitung nach Login"]]
        ],
        "wishlistButton" => [
            "details" => [
            ...
            "properties" => [
                "product" => ["description" => "Die ID des Produkts", "name" => "Produkt"],
                "variant" => ["description" => "Die ID der Variante", "name" => "Variante"]
            ]
        ],
        "wishlists" => [
            "details" => [
    ...
    "discounts" => [
        ...
        "triggers" => [
            ...
            "shipping_method" => "Die Versandart ist eine der folgenden",
    ...
    "order" => [
        ...
        "lang" => "Sprache",
        "modal" => ["cancel" => "Abbrechen", "update" => "Daten aktualisieren"],
    ...
    "order_state_settings" => ["description" => "Mögliche Status für Bestellungen verwalten"],
    "order_states" => [
        "color" => "Farbe",
    ...
    "payment_method_settings" => ["description" => "Zahlungsmethoden verwalten"],
    "payment_status" => [
    ...
    "plugin" => ["description" => "Ecommerce-Plattform für October CMS", "name" => "Mall"],
    ...
    "products" => ["variants_comment" => "Erstelle verschiedene Varianten des gleichen Produkts"],
    "properties" => [
    ...
    "shipping_method_settings" => ["description" => "Versandmethoden verwalten"],
    "tax" => [
    ...
    "tax_settings" => ["description" => "Steuern verwalten"],
    "titles" => [
        "brands" => ["create" => "Marke erstellen", "edit" => "Marke bearbeiten"],
        "categories" => [
            "create" => "Kategorie erstellen",
            "preview" => "Kategorie-Vorschau",
            "update" => "Kategorie bearbeiten"
        ],
        "custom_field_options" => ["edit" => "Feldoptionen bearbeiten"],
        "customer_groups" => ["create" => "Kundengruppe erstellen", "update" => "Kundengruppe bearbeiten"],
        "discounts" => [
        ...
        "orders" => ["export" => "Bestellungen exportieren", "show" => "Bestellungsdetails"],
        "payment_methods" => [
        ...
        "properties" => ["create" => "Eigenschaft erstellen", "edit" => "Eigenschaft bearbeiten"],
        "property_groups" => ["create" => "Gruppe erstellen", "edit" => "Gruppe bearbeiten"],
        "reviews" => ["create" => "Review erstellen", "update" => "Review bearbeiten"],
        "services" => ["create" => "Service erstellen", "update" => "Service bearbeiten"],
        "shipping_methods" => [
            "create" => "Versandmethode erstellen",
            "preview" => "Versandmethode-Vorschau",
            "update" => "Versandmethode bearbeiten"
        ],
        "taxes" => ["create" => "Steuer erstellen", "update" => "Steuer bearbeiten"]
    ],
    "variant" => ["method" => ["single" => "Artikel", "variant" => "Artikelvarianten"]]
];
