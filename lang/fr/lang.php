...
return [
    ...
    "components" => [
        ...
        "cart" => [
            ...
            "properties" => [
                ...
                "showProceedToCheckoutButton" => ["title" => "Afficher le bouton \"Passer commande\""],
                "showShipping" => ["title" => "Afficher les frais de port"],
        ...
        "signup" => [
            ...
            "errors" => [
                ...
                "terms_accepted" => ["required" => "Veuillez accepter nos conditions générales de vente. ."],
    ...
    "discounts" => [
        ...
        "triggers" => [
            ...
            "shipping_method" => "Le code de réduction est entré",
    ...
    "titles" => [
        ...
        "reviews" => ["create" => "Créer une critique", "update" => "Modifier la critique"],
        "services" => ["create" => "Créer un service", "update" => "Modifier un service"],
        "shipping_methods" => [
