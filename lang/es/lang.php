...
return [
    ...
    "components" => [
        "addressForm" => [
            ...
            "properties" => [
                ...
                "redirect" => ["title" => "Redirigir (después de guardar)"],
                "set" => ["title" => "Usar esta dirección como"]
            ],
            "redirects" => ["checkout" => "Página de Checkout"],
            "set" => ["billing" => "Dirección de facturación", "shipping" => "Dirección de despacho"]
        ],
        "addressList" => [
            "details" => [
        ...
        "cart" => [
            "details" => ["description" => "Muestra el carro de compras", "name" => "Carro"],
            "properties" => [
                "discountCodeLimit" => ["description" => "", "title" => ""],
                "showDiscountApplier" => ["title" => "Mostrar aplicador de descuento"],
                "showProceedToCheckoutButton" => ["title" => "Mostrar botón para proceder al checkout"],
                "showShipping" => ["title" => "Mostrar costo de despacho"],
                "showTaxes" => ["title" => "Mostrar impuestos"]
            ]
        ],
        "cartSummary" => [
            "details" => [
        ...
        "categories" => [
            ...
            "details" => ["description" => "Lista las categorías disponibles", "name" => "Cat3egorías"],
        ...
        "checkout" => [
            ...
            "errors" => ["missing_settings" => "Por favor seleccione un medio de pago y despacho."],
        ...
        "myAccount" => [
            ...
            "pages" => ["addresses" => "Direcciones", "orders" => "Pedidos", "profile" => "Perfil"],
            "properties" => ["page" => ["title" => "Subpágina activa"]]
        ],
        "ordersList" => [
            "details" => [
        ...
        "productReviews" => [
            ...
            "properties" => [
                ...
                "perPage" => ["title" => "Cantidad de reseñas por página"]
            ]
        ],
        "products" => [
            "details" => ["description" => "Muestra una lista de productos", "name" => "Productos"],
            "properties" => [
                "filter" => [
        ...
        "productsFilter" => [
            ...
            "properties" => [
                ...
                "showOnSaleFilter" => ["title" => "Mostrar filtro de artículos en oferta"],
                "showPriceFilter" => ["title" => "Mostrar filtro de precio"],
                "sortOrder" => ["description" => "Parámetro de pedido inicial", "title" => "Orden Predeterminado"]
            ],
            "sortOrder" => [
        ...
        "signup" => [
            ...
            "errors" => [
                "city" => ["required" => "Por favor ingresa tu ciudad."],
                "country_id" => [
                ...
                "lines" => ["required" => "Por favor ingresa tu dirección."],
                "login" => [
                ...
                "terms_accepted" => ["required" => "Debes aceptar los términos y condiciones para proceder."],
                ...
                "zip" => ["required" => "Por favor ingresa tu código postal."]
            ],
            "properties" => ["redirect" => ["name" => "Redirigir después del inicio de sesión"]]
        ],
        "wishlistButton" => [
            "details" => [
            ...
            "properties" => [
                "product" => ["description" => "ID del producto", "name" => "Producto"],
                "variant" => ["description" => "ID de la variante", "name" => "Variante"]
            ]
        ],
        "wishlists" => [
            "details" => [
    ...
    "order" => [
        ...
        "lang" => "Idioma",
        "modal" => ["cancel" => "Cancelar", "update" => "Actualizar información"],
    ...
    "order_state_settings" => ["description" => "Configurar estados de pedidos"],
    "order_states" => [
        "color" => "Color",
    ...
    "payment_method_settings" => ["description" => "Gestionar medios de pago"],
    "payment_status" => [
        "cancelled" => "Cancelado",
    ...
    "plugin" => ["description" => "Solución de E-commerce para October CMS", "name" => "Mall"],
    ...
    "products" => ["variants_comment" => "Crear diferentes variantes del mismo producto"],
    "properties" => [
        "filter_type" => "Tipo de filtro",
        "filter_types" => ["none" => "Sin filtro", "range" => "Rango", "set" => "Conjunto"],
    ...
    "shipping_method_settings" => ["description" => "Gestionar métodos de despacho"],
    "tax" => [
    ...
    "tax_settings" => ["description" => "Gestionar impuestos"],
    "titles" => [
        "brands" => ["create" => "Crear marca", "edit" => "Editar marca"],
        "categories" => [
            "create" => "Crear categoría",
            "preview" => "Previsualizar Categoría",
            "update" => "Editar categoría"
        ],
        "custom_field_options" => ["edit" => "Configurar opciones de campo"],
        "customer_groups" => ["create" => "Crear grupo", "update" => "Editar grupo"],
        "discounts" => [
        ...
        "orders" => ["export" => "Exportar pedidos", "show" => "Detalles de Orden"],
        "payment_methods" => [
        ...
        "properties" => ["create" => "Crear propiedades", "edit" => "Editar propiedades"],
        "property_groups" => ["create" => "Crear grupo", "edit" => "Editar grupo"],
        "reviews" => ["create" => "Crear reseña", "update" => "Editar reseña"],
        "services" => ["create" => "Crear servicio", "update" => "Editar servicio"],
        "shipping_methods" => [
            "create" => "Crear método de despacho",
            "preview" => "Previsualizar método de despacho",
            "update" => "Editar método de despacho"
        ],
        "taxes" => ["create" => "Crear impuesto", "update" => "Editar impuesto"]
    ],
    "variant" => ["method" => ["single" => "Artículo", "variant" => "Variantes de artículo"]]
];
