...
return [
    ...
    'discounts' => [
        ...
        'conditions' => 'Conditions',
        'conditions_operator' => 'Condition logic',
        'conditions_operator_comment' => 'Choose whether all conditions must match or any single condition is sufficient.',
        'conditions_operator_and' => 'All conditions must match (AND)',
        'conditions_operator_or' => 'Any condition must match (OR)',
        'minimum_total' => 'Minimum order total',
        'minimum_total_comment' => 'Amount in the default currency (e.g. 100 for €100)',
        'minimum_quantity' => 'Minimum quantity',
        'minimum_quantity_comment' => 'Leave empty to require at least 1. Quantities across all cart rows for this product are summed.',
        'shipping_methods' => 'Shipping methods',
        'types' => [
