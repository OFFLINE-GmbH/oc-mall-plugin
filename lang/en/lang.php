<?php return [
    ...
    'common'                   => [
        ...
        'downloads'            => 'Downloads',
        'download'             => 'Download',
        'please_log_in'        => 'Please log in to your customer account',
        'date_passed'          => 'You can\'t download it any more, the date is passed',
        'secure_download'      => 'Secure downloads',
        'version'              => 'Version',
        'display_name'         => 'Name to display',
        'file'                 => 'File to download',
        'limite_date'          => 'Date to limite download',
        'no_limite_date_needed' => 'Set 0 to set limit',
